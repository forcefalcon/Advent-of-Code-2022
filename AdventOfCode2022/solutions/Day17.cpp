...
static vector<vector<char>>* FlatShape = nullptr;
static vector<vector<char>>* CrossShape = nullptr;
static vector<vector<char>>* LShape = nullptr;
static vector<vector<char>>* TallShape = nullptr;
static vector<vector<char>>* BlockShape = nullptr;
...
void DaySeventeen::questionOne(istream& input, ostream& output)
{
    initRockShapes();
...
void DaySeventeen::questionTwo(istream& input, ostream& output)
{
    CurrentRock = 0;
    grid.resize(0);
    yOffset = 0;
