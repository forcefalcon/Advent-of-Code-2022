...
private:
	...
	static bool lessThan(const Cube& left, const Cube& right)
	{
	...
	void parse(istream& input, vector<Cube>& cubes, State& state)
	{
		string line;
	...
	bool expand(Cube& start, CubeSet& shape, State& state)
	{
...
DayEighteen g_dayEighteen = DayEighteen();
